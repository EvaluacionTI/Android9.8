...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        oEtCodigo = (EditText) findViewById(R.id.id_editTextCodigo);
        oEtAbreviatura = (EditText) findViewById(R.id.id_editTextAbreviatura);
        oEtDescripcion = (EditText) findViewById(R.id.id_editTextDescripcion);
        oTextView = findViewById(R.id.id_textViewConcatenar);
