...
public class CV0101v01GenerarTsecWithPost extends AppCompatActivity {
    private static final String TAG = CV0101v01GenerarTsecWithPost.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sRptaTsec= String.valueOf(UUID.randomUUID());
    ...
    private class getTsec extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            String lsMensaje = "Going for the network call.. .....!";
            super.onPreExecute();
            Toast.makeText(CV0101v01GenerarTsecWithPost.this, lsMensaje, Toast.LENGTH_LONG).show();
        }
