...
/*
    Revisar si hay conexion a internet
        ConnectivityManager oConnectivity = (ConnectivityManager) this.getSystemService(CONNECTIVITY_SERVICE);
        Network oInformatioNetwork = oConnectivity.getActiveNetwork();
*/

        getTsec oCallPost = new getTsec();
        oCallPost.execute();
